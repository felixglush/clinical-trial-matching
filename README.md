...
> **[docs/biomedical-primer.md](docs/biomedical-primer.md) is a short primer on the biology (diseases, genes, pathways, drugs, "mechanism") and how PrimeKG and TxGNN fit together.
